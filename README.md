...
#### 1. Главный интерфейс
![Главный интерфейс Voice2Voice AI](static/screenshots/Screenshot.png)

#### 2. Скриншоты чата
![Чат с Voice2Voice AI](static/screenshots/Screenshot_2.png)

![Чат с Voice2Voice AI](static/screenshots/Screenshot_3.png)

![Чат с Voice2Voice AI](static/screenshots/Screenshot_4.png) 

> 📁 **Дополнительные скриншоты**: Больше изображений системы доступно в директории [`voice2voice-ai/static/screenshots`](static/screenshots/)
